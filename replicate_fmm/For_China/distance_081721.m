...
% Updated by Ke on 11/8/24, for replicate on China. 
% Notice: 
...
%    cd ..
    ...
    % filter rules
        thicker_pen_filter = fspecial('disk',5);
    ...
    % Ming Dynasty Road data
        ...
        % agg
        ming_roads = (on_land + water_way + mixed_road)>0;
    ...
    % 1996 data
        ...
        % getting each type of road
            ...
            % medium roads are red 
                ...
                med_roads = med_roads.*in_china.*(1-highways);     
            ...
            % tiny roads are fuscia
                ...
                tiny_roads  = tiny_roads.*in_china.*(1-med_roads-highways);   
...
% Converting to speed images
    ...
    speed_2011 = (speed_highway.*highways_2011 + speed_med.*med_roads_2011 + speed_small.*tiny_roads_2011)+(1-roads_2011).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_2004 = (speed_highway.*highways_2004 + speed_med.*med_roads_2004 + speed_small.*tiny_roads_2004)+(1-roads_2004).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_1996 = (speed_highway.*highways_1996 + speed_med.*med_roads_1996 + speed_small.*tiny_roads_1996)+(1-roads_1996).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_1988 = (speed_highway.*highways_1988 + speed_med.*med_roads_1988 + speed_small.*tiny_roads_1988)+(1-roads_1988).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_1977 = (speed_highway.*highways_1977 + speed_med.*med_roads_1977 + speed_small.*tiny_roads_1977)+(1-roads_1977).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_1969 = (speed_highway.*highways_1969 + speed_med.*med_roads_1969 + speed_small.*tiny_roads_1969)+(1-roads_1969).*in_china*speed_india + (1-in_china)*speed_elsewhere;
    speed_1962 = (speed_highway.*highways_1962 + speed_med.*med_roads_1962 + speed_small.*tiny_roads_1962)+(1-roads_1962).*in_china*speed_india + (1-in_china)*speed_elsewhere;
